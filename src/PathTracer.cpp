...
PathTracer::PathTracer(const std::string & scene_name)
{
...
//	Sphere *sp1 = new Sphere(8.5,  Vector(0, 8.5, 17), Vector(), Vector(1.0, 1.0, 1.0) * .999, SPEC);
	Sphere *sp2 = new Sphere(8.5,  Vector(-20, 8.5, 25), Vector(), Vector(1.0, 1.0, 0.0) * .999, DIFF);
	Sphere *sp3 = new Sphere(2.0, Vector(0, 80, 17), Vector(80,80,80), Vector(1.0,1.0,1.0) * .999, DIFF);
